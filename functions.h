...
// above are all the functions include and data types we need
...
// specialized version of GetText that is towards the class question response
char GetClass(string classquestion)
{
	char response;
	do
...
// this function GetTextFromUser is what the player is directed at for yes or no questions
char GetTextFromUser(string ynquestion)
{
	char response;
	do
